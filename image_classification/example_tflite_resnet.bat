...
python prediction.py -m resnet50 --tflite -p legacy t=1_crop -d imagenet
python prediction.py -m resnet50 --tflite -p t=1_crop -d imagenet
python prediction.py -m resnet50 --tflite -p t=1_crop tflite -d imagenet
...
python accuracy.py -m resnet50 -d imagenet__legacy_t_1_crop_tflite
python accuracy.py -m resnet50 -d imagenet__t_1_crop_tflite
python accuracy.py -m resnet50 -d imagenet__t_1_crop_tflite_tflite
